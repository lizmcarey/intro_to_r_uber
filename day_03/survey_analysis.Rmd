...
Let's relevel the response options to give them order. 
```{r}
Q1_table <- 
  Q1_table %>% 
  mutate(Q1 = 
...
```
Sometimes our stakeholders are only interested in the Top 2 Boxes. Let's calculate them by grouping the varaibles together. We can do this by using the `case_when()` function. 
